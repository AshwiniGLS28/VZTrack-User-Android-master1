...
import vztrack.gls.com.vztrack_user.beans.SectionModel;
...
////                Toast.makeText(context, "clicked", Toast.LENGTH_SHORT).show();//.makeText(context, "You clicked on Show All of : " + sectionModel.getSectionLabel(), Toast.LENGTH_SHORT).show();
////            }
////        });
//
//    }
