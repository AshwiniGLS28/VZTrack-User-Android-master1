...
public class RequestRideFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_request_ride, null);
        CleverTap.cleverTap_Record_Event(context, Events.car_pool_request_screen);
        context = MainActivity.mainActivity;
        cc = new CheckConnection(getActivity());
        setHasOptionsMenu(true);
        mRecyclerView = (RecyclerView) root.findViewById(R.id.recycler_view_request_ride);
