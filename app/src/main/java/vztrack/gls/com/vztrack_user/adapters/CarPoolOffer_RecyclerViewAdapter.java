...
public class CarPoolOffer_RecyclerViewAdapter extends RecyclerView.Adapter<CarPoolOffer_RecyclerViewAdapter.MyViewHolder> {
...
//            imgCall = (ImageView) view.findViewById(R.id.imgCall);
    ...
    public CarPoolOffer_RecyclerViewAdapter(Context con, ArrayList<CarPoolBean> carPoolBeans) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        if (id == -1) {
            ...
            holder.header.setText("My Offer");
            click = true;
        } else if (id == -2) {
            holder.header.setVisibility(View.VISIBLE);
            holder.cvPoolCar.setVisibility(View.GONE);
            holder.header.setText("Other Offers");
            click = false;
        } else {
            ...
            if(click == true){
                ...
                holder.cvPoolCar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        txtalertheading.setText("Close My Offer");
                        txtalertsubheading.setText("Do you really want to close this offer?");
                        ...
                        btnpositive.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (cc.isConnectingToInternet()) {
                                    new GetData(MainActivity.mainActivity, CallFor.CLOSE_CAR_POOL_OFFERS, ""+id).execute();
                                    CleverTap.cleverTap_Record_Event(context, Events.car_pool_close_offer);
                                } else {
...
//                                .setTitleText("Close My Offer")
//                                .setContentText("Do you really want to close this offer?")
